...
This is Bai Jingyao's FastSpeech2 training and testing project.
Referenced from https://github.com/ming024/FastSpeech2
In this research project, I conducted a comprehensive study and testing of the FastSpeech2 model training steps.
Please ensure strict adherence to the procedures and check that the files in the 
FastSpeech2\raw_data\LJSpeech\LJSpeech 
FastSpeech2\preprocessed_data\LJSpeech\TextGrid\LJSpeech 
directories are complete and intact. Note that the original author has an additional nested directory in raw_data, which requires extra attention. Also, do not delete the pre-existing contents in the FastSpeech2\preprocessed_data\LJSpeech folder, as this may lead to errors during the MFA alignment stage.
